...
import { RequestManager, PostMessageTransport, WebSocketTransport, HTTPTransport, Client, JSONRPCError } from "@open-rpc/client-js";
...
export interface Options {
  transport: {
    type: "websocket" | "http" | "https" | "postmessage";
    host: string;
    port: number;
    path?: string;
    protocol?: string;
    postMessageType?: "iframe" | "window";
  },
}
...
export class <%= className %> {
  ...
  public transport: HTTPTransport | WebSocketTransport | PostMessageTransport;
  ...
  constructor(options: Options) {
    ...
    const {type, host, port, protocol, postMessageType} = options.transport;
    ...
    switch (type) {
      ...
      case 'websocket':
        ...
        break;
      case 'postmessage':
        this.transport = new PostMessageTransport(protocol + "://" + host + ":" + port + path, postMessageType || "iframe");
        break;
      default:
